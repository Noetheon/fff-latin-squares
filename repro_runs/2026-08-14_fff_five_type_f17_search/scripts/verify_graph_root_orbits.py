...
def main() -> None:
    ...
    if not all(dimension_checks.values()):
        raise SystemExit("invalid f17 dimension record")
    ...
    if root != expected_root:
        raise SystemExit("graph does not contain the canonical f17 root")
    ...
    expected_orbit_size_counts = {12: 3, 24: 1, 48: 69}
    ...
    args.summary.write_text("\n".join([
        "Five-type f17 graph root-orbit audit", "",
