...
def main() -> None:
    ...
    if not all(dimension_checks.values()):
        raise SystemExit("invalid f18 dimension record")
    ...
    if root != expected_root:
        raise SystemExit("graph does not contain the canonical f18 root")
    ...
    expected_orbit_size_counts = {12: 6, 24: 2, 48: 50}
    ...
    args.summary.write_text("\n".join([
        "Five-type f18 graph root-orbit audit", "",
