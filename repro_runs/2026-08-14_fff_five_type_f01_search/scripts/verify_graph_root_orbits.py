...
def main() -> None:
    ...
    if not all(dimension_checks.values()):
        raise SystemExit("invalid f01 dimension record")
    ...
    if root != expected_root:
        raise SystemExit("graph does not contain the canonical f01 involution root")
    ...
    expected_orbit_size_counts = {12: 6, 24: 2, 48: 20}
    ...
    args.summary.write_text("\n".join([
        "Five-type graph root-orbit audit", "",
